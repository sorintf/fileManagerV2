                    ...
                    <div class="row my-3">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0 me-2">Structura folderului: <?php echo $adminFunctions->rep['client']->name; ?></h5>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <form action="" method="post" class="needs-validation" novalidate>
                                    ...
                                    <div class="form-group text-center">
                                        <input type="hidden" name="id_client" value="<?php echo $adminFunctions->rep['client']->ID; ?>">
                                        <input class="btn btn-danger" type="submit" name="client_delete" value="Sterge">
                                    </div>
                                </form>
                            </div>
                        </div>
